...
export default function SetGridGap(): JSX.Element {
  useEffect(() => {
    const setGapSize = () => {
      const root = document.querySelector(':root') as HTMLElement;
      const container = document.querySelector('.getGapSize__grid_32') as HTMLElement;
  ...
  return (
    <Section classProp="getGapSize__container">
      <Container classProp="getGapSize__grid_32" children={undefined} />
    </Section>
  );
}
